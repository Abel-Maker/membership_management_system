...
class TempalteHook{
	...
	public function templateParse($template){
        ...
        $this->_template_replace[] = "<?php \$__Template->display(\"".THEME_NAME.'/'.TPL_DIR.'/'.TPL_NAME."/$1\"); ?>";
		...
		$template = str_replace('__STATIC__', __STATIC__, $template);
		$template = str_replace('__UPLOAD__', __UPLOAD__, $template);
